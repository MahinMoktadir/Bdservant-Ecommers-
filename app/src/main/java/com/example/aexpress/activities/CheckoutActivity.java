...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CartAdapter(this, products, new CartAdapter.CartListener() {
            ...
            public void onQuantityChanged() {
                binding.subtotal.setText(String.format("BDT",cart.getTotalPrice()));
            }
        });
    ...
    void processOrder() {
        ...
        try {
            ...
            productOrder.put("Customer",binding.nameBox.getText().toString());
            ...
            productOrder.put("date of service", Calendar.getInstance().getTimeInMillis());
            ...
            productOrder.put("Service running", "");
            productOrder.put("Service Location", "");
            productOrder.put("Service Rate", "0.0");
            ...
            for(Map.Entry<Item, Integer> item : cart.getAllItemsWithQty().entrySet()) {
                ...
                productObj.put("Service items", product.getPrice());
                productObj.put("Servant id", product.getId());
                productObj.put("Servant Name", product.getName());
                product_order_detail.put(productObj);
            }

            dataObject.put("Service Taken",productOrder);
            dataObject.put("Service Details",product_order_detail);
                ...
                try {
                    if (response.getString("status").equals("success")) {
                        ...
                        new AlertDialog.Builder(CheckoutActivity.this)
                                .setTitle("Service  Successful")
                                .setCancelable(false)
                                .setMessage("Your Service number is: " + orderNumber)
                        .setPositiveButton("Pay Now", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Intent intent = new Intent(CheckoutActivity.this, PaymentActivity.class);
                                intent.putExtra("Servant code", orderNumber);
                                startActivity(intent);
                            }
                        }).show();
                    } else {
                        new AlertDialog.Builder(CheckoutActivity.this)
                                .setTitle("Service Procedure Failed")
